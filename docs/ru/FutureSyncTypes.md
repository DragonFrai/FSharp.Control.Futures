...
Если значение мьютекса — это просто данные, которые меняются мгновенно,
не требуя асинхронных операций между блокировкой и освобождением,
часто уместно использовать блокирующий мьютекс,
если конечно степень конкурентности не слишком велика.
...
также можно создать задачу для управления ресурсом ввода-вывода и использовать передачу сообщений для взаимодействия с этой задачей.
